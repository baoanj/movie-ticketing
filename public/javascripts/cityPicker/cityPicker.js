...
IIInsomniaCityPicker.prototype = {
  ...
  buildProvinceTpl: function() {
    ...
    province_html += '<li class="IIInsomnia-clean"><input type="button" class="IIInsomnia-clean-btn" id="IIInsomnia_clean_btn" value="定位"></li>'
  ...
  cityEvent: function() {
    ...
    that.hot_city.on('click', '.IIInsomnia-hot-city', function(event) {
      ...
      that.settings.target.html(cname + '<strong class="caret"></strong>');
  ...
  cleanBtnEvent: function() {
    ...
    that.province_wrap.on('click', '#IIInsomnia_clean_btn', function(event) {
      ...
      event.stopPropagation();
      /* Act on the event */
      that.settings.target.html(CITY + '<strong class="caret"></strong>');
